interface button {
  ...
  class Calculator {
    currentTotal: number; // current running total 
    currentOperator: string; //  active operator 
    lastOperator: string; //  last operator pressed
    ...
    numberPressed = (btn: button) => {
      ...
      // replace them with the number pressed
